...
[Black "yyy"]
[Result "0-1"]
[CurrentPosition "r1b1kb1r/p1p4p/1pq1pn2/4P3/8/2N5/PPP2PPP/R1BQK2R w KQkq -"]
[Timezone "UTC"]
[ECO "C00"]
[ECOUrl "https://www.chess.com/openings/Pirc-Defense-Small-Center-Defense"]
[WhiteUrl "35.f144aa58.50x50o.618459b7a2.jpg"]
[BlackTitle ""]
...
Qd7 9. Bxc6 Qxc6 10. Nxe6 fxe6 0-1`,
			...
			[]pgn.Header{
				...
				pgn.NewHeader("Round", "-"),
				pgn.NewHeader("White", "xxx"),
				pgn.NewHeader("Black", "yyy"),
				pgn.NewHeader("Result", "0-1"),
				pgn.NewHeader("CurrentPosition", "r1b1kb1r/p1p4p/1pq1pn2/4P3/8/2N5/PPP2PPP/R1BQK2R w KQkq -"),
				pgn.NewHeader("Timezone", "UTC"),
				pgn.NewHeader("ECO", "C00"),
				pgn.NewHeader("ECOUrl", "https://www.chess.com/openings/Pirc-Defense-Small-Center-Defense"),
